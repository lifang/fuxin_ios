...
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  ...
  if (self.hasGender) {
    [output writeInt32:6 value:self.gender];
  }
  if (self.hasSource) {
  ...
  if (self.hasSignature) {
    [output writeString:12 value:self.signature];
  }
  [self.unknownFields writeToCodedOutputStream:output];
}
- (int32_t) serializedSize {
  ...
  if (self.hasGender) {
    size += computeInt32Size(6, self.gender);
  }
  if (self.hasSource) {
    size += computeStringSize(7, self.source);
  }
  if (self.hasTileUrl) {
  ...
  if (self.hasSignature) {
    size += computeStringSize(12, self.signature);
  }
  size += self.unknownFields.serializedSize;
  memoizedSerializedSize = size;
  return size;
...
- (Contact_Builder*) setUserId:(int32_t) value {
  result.hasUserId = YES;
  result.userId = value;
  return self;
}
- (Contact_Builder*) clearUserId {
  result.hasUserId = NO;
  result.userId = 0;
  return self;
}
...
- (Contact_Builder*) setSource:(NSString*) value {
...
BOOL Profile_ContactSourceTypeIsValidValue(Profile_ContactSourceType value) {
  switch (value) {
    case Profile_ContactSourceTypeOrderFrom:
    case Profile_ContactSourceTypeOrderTo:
    case Profile_ContactSourceTypeSubscribeFrom:
    case Profile_ContactSourceTypeSubscribeTo:
      return YES;
    default:
      return NO;
  }
...
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  ...
  if (self.hasSendTime) {
    [output writeString:3 value:self.sendTime];
  }
  [self.unknownFields writeToCodedOutputStream:output];
}
- (int32_t) serializedSize {
  ...
  if (self.hasSendTime) {
    size += computeStringSize(3, self.sendTime);
  }
  size += self.unknownFields.serializedSize;
  memoizedSerializedSize = size;
  return size;
...
+ (MessageInfo_Builder*) builder {
  return [[[MessageInfo_Builder alloc] init] autorelease];
}
+ (MessageInfo_Builder*) builderWithPrototype:(MessageInfo*) prototype {
...
@interface MessageInfo_Builder()
@property (retain) MessageInfo* result;
@end

@implementation MessageInfo_Builder
@synthesize result;
- (void) dealloc {
  self.result = nil;
  [super dealloc];
...
- (id) init {
  if ((self = [super init])) {
    self.result = [[[MessageInfo alloc] init] autorelease];
  }
  return self;
}
- (PBGeneratedMessage*) internalGetResult {
...
- (MessageInfo_Builder*) clear {
  self.result = [[[MessageInfo alloc] init] autorelease];
  return self;
}
- (MessageInfo_Builder*) clone {
  return [MessageInfo builderWithPrototype:result];
}
- (MessageInfo*) defaultInstance {
...
- (MessageInfo*) buildPartial {
  MessageInfo* returnMe = [[result retain] autorelease];
  self.result = nil;
  return returnMe;
}
- (MessageInfo_Builder*) mergeFrom:(MessageInfo*) other {
...
- (MessageInfo_Builder*) mergeFromCodedInputStream:(PBCodedInputStream*) input {
  return [self mergeFromCodedInputStream:input extensionRegistry:[PBExtensionRegistry emptyRegistry]];
}
- (MessageInfo_Builder*) mergeFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  PBUnknownFieldSet_Builder* unknownFields = [PBUnknownFieldSet builderWithUnknownFields:self.unknownFields];
  while (YES) {
    int32_t tag = [input readTag];
    switch (tag) {
...
- (MessageInfo_Builder*) setUserId:(int32_t) value {
  result.hasUserId = YES;
  result.userId = value;
  return self;
}
- (MessageInfo_Builder*) clearUserId {
  result.hasUserId = NO;
  result.userId = 0;
  return self;
}
...
- (MessageInfo_Builder*) setMessageCount:(int32_t) value {
  result.hasMessageCount = YES;
  result.messageCount = value;
  return self;
}
- (MessageInfo_Builder*) clearMessageCount {
...
- (MessageInfo_Builder*) setSendTime:(NSString*) value {
  result.hasSendTime = YES;
  result.sendTime = value;
  return self;
}
- (MessageInfo_Builder*) clearSendTime {
...
@interface MessageInfoRequest ()
@property (retain) NSString* token;
@property int32_t userId;
@property (retain) NSString* timeStamp;
@end

@implementation MessageInfoRequest
...
static MessageInfoRequest* defaultMessageInfoRequestInstance = nil;
+ (void) initialize {
  if (self == [MessageInfoRequest class]) {
    defaultMessageInfoRequestInstance = [[MessageInfoRequest alloc] init];
  }
}
+ (MessageInfoRequest*) defaultInstance {
  return defaultMessageInfoRequestInstance;
}
- (MessageInfoRequest*) defaultInstance {
  return defaultMessageInfoRequestInstance;
}
...
+ (MessageInfoRequest*) parseFromData:(NSData*) data {
  return (MessageInfoRequest*)[[[MessageInfoRequest builder] mergeFromData:data] build];
}
+ (MessageInfoRequest*) parseFromData:(NSData*) data extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (MessageInfoRequest*)[[[MessageInfoRequest builder] mergeFromData:data extensionRegistry:extensionRegistry] build];
}
+ (MessageInfoRequest*) parseFromInputStream:(NSInputStream*) input {
  return (MessageInfoRequest*)[[[MessageInfoRequest builder] mergeFromInputStream:input] build];
}
+ (MessageInfoRequest*) parseFromInputStream:(NSInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (MessageInfoRequest*)[[[MessageInfoRequest builder] mergeFromInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (MessageInfoRequest*) parseFromCodedInputStream:(PBCodedInputStream*) input {
  return (MessageInfoRequest*)[[[MessageInfoRequest builder] mergeFromCodedInputStream:input] build];
}
+ (MessageInfoRequest*) parseFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (MessageInfoRequest*)[[[MessageInfoRequest builder] mergeFromCodedInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (MessageInfoRequest_Builder*) builder {
  return [[[MessageInfoRequest_Builder alloc] init] autorelease];
}
+ (MessageInfoRequest_Builder*) builderWithPrototype:(MessageInfoRequest*) prototype {
  return [[MessageInfoRequest builder] mergeFrom:prototype];
}
- (MessageInfoRequest_Builder*) builder {
  return [MessageInfoRequest builder];
}
@end

@interface MessageInfoRequest_Builder()
@property (retain) MessageInfoRequest* result;
@end

@implementation MessageInfoRequest_Builder
@synthesize result;
- (void) dealloc {
  self.result = nil;
  [super dealloc];
...
- (id) init {
  if ((self = [super init])) {
    self.result = [[[MessageInfoRequest alloc] init] autorelease];
  }
  return self;
}
- (PBGeneratedMessage*) internalGetResult {
...
- (MessageInfoRequest_Builder*) clear {
  self.result = [[[MessageInfoRequest alloc] init] autorelease];
  return self;
}
- (MessageInfoRequest_Builder*) clone {
  return [MessageInfoRequest builderWithPrototype:result];
}
- (MessageInfoRequest*) defaultInstance {
  return [MessageInfoRequest defaultInstance];
}
- (MessageInfoRequest*) build {
  [self checkInitialized];
  return [self buildPartial];
}
- (MessageInfoRequest*) buildPartial {
  MessageInfoRequest* returnMe = [[result retain] autorelease];
  self.result = nil;
  return returnMe;
}
- (MessageInfoRequest_Builder*) mergeFrom:(MessageInfoRequest*) other {
  if (other == [MessageInfoRequest defaultInstance]) {
    return self;
  }
  if (other.hasToken) {
    [self setToken:other.token];
...
- (MessageInfoRequest_Builder*) mergeFromCodedInputStream:(PBCodedInputStream*) input {
  return [self mergeFromCodedInputStream:input extensionRegistry:[PBExtensionRegistry emptyRegistry]];
}
- (MessageInfoRequest_Builder*) mergeFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  PBUnknownFieldSet_Builder* unknownFields = [PBUnknownFieldSet builderWithUnknownFields:self.unknownFields];
  while (YES) {
    int32_t tag = [input readTag];
    switch (tag) {
...
- (MessageInfoRequest_Builder*) setToken:(NSString*) value {
  result.hasToken = YES;
  result.token = value;
  return self;
}
- (MessageInfoRequest_Builder*) clearToken {
  result.hasToken = NO;
  result.token = @"";
  return self;
}
...
- (MessageInfoRequest_Builder*) setUserId:(int32_t) value {
  result.hasUserId = YES;
  result.userId = value;
  return self;
}
- (MessageInfoRequest_Builder*) clearUserId {
  result.hasUserId = NO;
  result.userId = 0;
  return self;
}
...
- (MessageInfoRequest_Builder*) setTimeStamp:(NSString*) value {
  result.hasTimeStamp = YES;
  result.timeStamp = value;
  return self;
}
- (MessageInfoRequest_Builder*) clearTimeStamp {
...
@property BOOL isSucceed;
@property (retain) NSMutableArray* mutableMessageInfoList;
@end

@implementation MessageInfoResponse
...
@synthesize mutableMessageInfoList;
- (void) dealloc {
  self.mutableMessageInfoList = nil;
  [super dealloc];
}
- (id) init {
  if ((self = [super init])) {
...
static MessageInfoResponse* defaultMessageInfoResponseInstance = nil;
+ (void) initialize {
  if (self == [MessageInfoResponse class]) {
    defaultMessageInfoResponseInstance = [[MessageInfoResponse alloc] init];
  }
}
+ (MessageInfoResponse*) defaultInstance {
  return defaultMessageInfoResponseInstance;
}
- (MessageInfoResponse*) defaultInstance {
  return defaultMessageInfoResponseInstance;
}
- (NSArray*) messageInfoList {
  return mutableMessageInfoList;
}
- (MessageInfo*) messageInfoAtIndex:(int32_t) index {
  id value = [mutableMessageInfoList objectAtIndex:index];
  return value;
}
- (BOOL) isInitialized {
  return YES;
...
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  ...
  for (MessageInfo* element in self.messageInfoList) {
    [output writeMessage:2 value:element];
  }
  [self.unknownFields writeToCodedOutputStream:output];
}
...
+ (MessageInfoResponse*) parseFromData:(NSData*) data {
  return (MessageInfoResponse*)[[[MessageInfoResponse builder] mergeFromData:data] build];
}
+ (MessageInfoResponse*) parseFromData:(NSData*) data extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (MessageInfoResponse*)[[[MessageInfoResponse builder] mergeFromData:data extensionRegistry:extensionRegistry] build];
}
+ (MessageInfoResponse*) parseFromInputStream:(NSInputStream*) input {
  return (MessageInfoResponse*)[[[MessageInfoResponse builder] mergeFromInputStream:input] build];
}
+ (MessageInfoResponse*) parseFromInputStream:(NSInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (MessageInfoResponse*)[[[MessageInfoResponse builder] mergeFromInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (MessageInfoResponse*) parseFromCodedInputStream:(PBCodedInputStream*) input {
  return (MessageInfoResponse*)[[[MessageInfoResponse builder] mergeFromCodedInputStream:input] build];
}
+ (MessageInfoResponse*) parseFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  return (MessageInfoResponse*)[[[MessageInfoResponse builder] mergeFromCodedInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (MessageInfoResponse_Builder*) builder {
  return [[[MessageInfoResponse_Builder alloc] init] autorelease];
}
+ (MessageInfoResponse_Builder*) builderWithPrototype:(MessageInfoResponse*) prototype {
  return [[MessageInfoResponse builder] mergeFrom:prototype];
}
- (MessageInfoResponse_Builder*) builder {
...
@interface MessageInfoResponse_Builder()
@property (retain) MessageInfoResponse* result;
@end

@implementation MessageInfoResponse_Builder
@synthesize result;
- (void) dealloc {
  self.result = nil;
  [super dealloc];
...
- (id) init {
  if ((self = [super init])) {
    self.result = [[[MessageInfoResponse alloc] init] autorelease];
  }
  return self;
}
- (PBGeneratedMessage*) internalGetResult {
...
- (MessageInfoResponse_Builder*) clear {
  self.result = [[[MessageInfoResponse alloc] init] autorelease];
  return self;
}
- (MessageInfoResponse_Builder*) clone {
  return [MessageInfoResponse builderWithPrototype:result];
}
- (MessageInfoResponse*) defaultInstance {
  return [MessageInfoResponse defaultInstance];
}
- (MessageInfoResponse*) build {
  [self checkInitialized];
  return [self buildPartial];
}
- (MessageInfoResponse*) buildPartial {
  MessageInfoResponse* returnMe = [[result retain] autorelease];
  self.result = nil;
  return returnMe;
}
- (MessageInfoResponse_Builder*) mergeFrom:(MessageInfoResponse*) other {
  if (other == [MessageInfoResponse defaultInstance]) {
    return self;
  }
  if (other.hasIsSucceed) {
    [self setIsSucceed:other.isSucceed];
  }
  if (other.mutableMessageInfoList.count > 0) {
    if (result.mutableMessageInfoList == nil) {
      result.mutableMessageInfoList = [NSMutableArray array];
    }
    [result.mutableMessageInfoList addObjectsFromArray:other.mutableMessageInfoList];
  }
  [self mergeUnknownFields:other.unknownFields];
  return self;
}
- (MessageInfoResponse_Builder*) mergeFromCodedInputStream:(PBCodedInputStream*) input {
  return [self mergeFromCodedInputStream:input extensionRegistry:[PBExtensionRegistry emptyRegistry]];
}
- (MessageInfoResponse_Builder*) mergeFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  PBUnknownFieldSet_Builder* unknownFields = [PBUnknownFieldSet builderWithUnknownFields:self.unknownFields];
  while (YES) {
    int32_t tag = [input readTag];
    switch (tag) {
      ...
      case 18: {
        MessageInfo_Builder* subBuilder = [MessageInfo builder];
        [input readMessage:subBuilder extensionRegistry:extensionRegistry];
        [self addMessageInfo:[subBuilder buildPartial]];
        break;
      }
    }
  }
...
- (MessageInfoResponse_Builder*) setIsSucceed:(BOOL) value {
  result.hasIsSucceed = YES;
  result.isSucceed = value;
  return self;
}
- (MessageInfoResponse_Builder*) clearIsSucceed {
  result.hasIsSucceed = NO;
  result.isSucceed = NO;
  return self;
}
- (NSArray*) messageInfoList {
  if (result.mutableMessageInfoList == nil) { return [NSArray array]; }
  return result.mutableMessageInfoList;
}
- (MessageInfo*) messageInfoAtIndex:(int32_t) index {
  return [result messageInfoAtIndex:index];
}
- (MessageInfoResponse_Builder*) replaceMessageInfoAtIndex:(int32_t) index with:(MessageInfo*) value {
  [result.mutableMessageInfoList replaceObjectAtIndex:index withObject:value];
  return self;
}
- (MessageInfoResponse_Builder*) addAllMessageInfo:(NSArray*) values {
  if (result.mutableMessageInfoList == nil) {
    result.mutableMessageInfoList = [NSMutableArray array];
  }
  [result.mutableMessageInfoList addObjectsFromArray:values];
  return self;
}
- (MessageInfoResponse_Builder*) clearMessageInfoList {
  result.mutableMessageInfoList = nil;
  return self;
}
- (MessageInfoResponse_Builder*) addMessageInfo:(MessageInfo*) value {
  if (result.mutableMessageInfoList == nil) {
    result.mutableMessageInfoList = [NSMutableArray array];
  }
  [result.mutableMessageInfoList addObject:value];
  return self;
}
@end
...
- (MessageRequest_Builder*) setContactId:(int32_t) value {
  result.hasContactId = YES;
  result.contactId = value;
  return self;
}
- (MessageRequest_Builder*) clearContactId {
  result.hasContactId = NO;
  result.contactId = 0;
  return self;
}
...
- (MessageResponse_Builder*) setContactId:(int32_t) value {
  result.hasContactId = YES;
  result.contactId = value;
  return self;
}
- (MessageResponse_Builder*) clearContactId {
  result.hasContactId = NO;
  result.contactId = 0;
  return self;
}
...
- (MessageResponse_Builder*) replaceMessagesAtIndex:(int32_t) index with:(Message*) value {
  [result.mutableMessagesList replaceObjectAtIndex:index withObject:value];
  return self;
}
- (MessageResponse_Builder*) addAllMessages:(NSArray*) values {
  if (result.mutableMessagesList == nil) {
    result.mutableMessagesList = [NSMutableArray array];
  }
...
- (MessageResponse_Builder*) clearMessagesList {
  result.mutableMessagesList = nil;
  return self;
}
- (MessageResponse_Builder*) addMessages:(Message*) value {
  if (result.mutableMessagesList == nil) {
    result.mutableMessagesList = [NSMutableArray array];
  }
...
- (SendMessageResponse_Builder*) setMessage:(NSString*) value {
  result.hasMessage = YES;
  result.message = value;
  return self;
}
- (SendMessageResponse_Builder*) clearMessage {
  result.hasMessage = NO;
  result.message = @"";
  return self;
}
...
- (RegisterResponse_Builder*) replaceMessagesAtIndex:(int32_t) index with:(Message*) value {
  [result.mutableMessagesList replaceObjectAtIndex:index withObject:value];
  return self;
}
- (RegisterResponse_Builder*) addAllMessages:(NSArray*) values {
  if (result.mutableMessagesList == nil) {
    result.mutableMessagesList = [NSMutableArray array];
  }
  [result.mutableMessagesList addObjectsFromArray:values];
...
- (RegisterResponse_Builder*) clearMessagesList {
  result.mutableMessagesList = nil;
  return self;
}
- (RegisterResponse_Builder*) addMessages:(Message*) value {
  if (result.mutableMessagesList == nil) {
    result.mutableMessagesList = [NSMutableArray array];
  }
  [result.mutableMessagesList addObject:value];
...
- (ChangePasswordResponse_Builder*) replaceMessagesAtIndex:(int32_t) index with:(Message*) value {
  [result.mutableMessagesList replaceObjectAtIndex:index withObject:value];
  return self;
}
- (ChangePasswordResponse_Builder*) addAllMessages:(NSArray*) values {
  if (result.mutableMessagesList == nil) {
    result.mutableMessagesList = [NSMutableArray array];
  }
  [result.mutableMessagesList addObjectsFromArray:values];
...
- (ChangePasswordResponse_Builder*) clearMessagesList {
  result.mutableMessagesList = nil;
  return self;
}
- (ChangePasswordResponse_Builder*) addMessages:(Message*) value {
  if (result.mutableMessagesList == nil) {
    result.mutableMessagesList = [NSMutableArray array];
  }
  [result.mutableMessagesList addObject:value];
